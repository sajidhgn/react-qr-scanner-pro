...
var QrCameraScanner = function QrCameraScanner(_ref) {
  var onResult = _ref.onResult,
    onError = _ref.onError,
    _ref$style = _ref.style,
    style = _ref$style === void 0 ? {} : _ref$style,
    _ref$videoStyle = _ref.videoStyle,
    videoStyle = _ref$videoStyle === void 0 ? {} : _ref$videoStyle,
    _ref$facingMode = _ref.facingMode,
    facingMode = _ref$facingMode === void 0 ? 'environment' : _ref$facingMode,
    _ref$scanDelay = _ref.scanDelay,
    scanDelay = _ref$scanDelay === void 0 ? 100 : _ref$scanDelay,
  ...
  var scanIntervalRef = react.useRef(null);
  var stopCamera = react.useCallback(function () {
  ...
  var scanFrame = react.useCallback(function () {
    var video = videoRef.current;
  ...
  var startCamera = react.useCallback(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var stream, video, errorMessage, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 4:
          _context.p = 4;
          _t = _context.v;
          errorMessage = "Camera error: ".concat(_t.message);
  ...
  var defaultVideoStyle = _objectSpread2({
    width: '100%',
    maxWidth: '500px',
    height: 'auto',
    borderRadius: '8px'
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    }), isScanning && /*#__PURE__*/jsxRuntime.jsx("p", {
      style: {
        marginTop: '1rem',
        textAlign: 'center'
      },
      children: "Scanning for QR codes..."
    })]
  });
};

var QrImageUploader = function QrImageUploader(_ref) {
  var onResult = _ref.onResult,
    onError = _ref.onError,
    _ref$style = _ref.style,
    style = _ref$style === void 0 ? {} : _ref$style,
    ...
    buttonText = _ref$buttonText === void 0 ? 'Choose Image' : _ref$buttonText,
    _ref$acceptedFormats = _ref.acceptedFormats,
    acceptedFormats = _ref$acceptedFormats === void 0 ? 'image/*' : _ref$acceptedFormats,
    _ref$showPreview = _ref.showPreview,
    showPreview = _ref$showPreview === void 0 ? true : _ref$showPreview,
    _ref$previewStyle = _ref.previewStyle,
  ...
  var processImage = function processImage(file) {
    ...
    img.onload = function () {
      try {
        ...
        if (code && code.data) {
          ...
          var errorMessage = 'No QR code found in the image';
          setError(errorMessage);
          if (onError) {
        ...
        setIsProcessing(false);
        var _errorMessage = "Error processing image: ".concat(err.message);
    ...
    img.onerror = function () {
      setIsProcessing(false);
      var errorMessage = 'Error loading image';
      setError(errorMessage);
      if (onError) {
        onError(new Error(errorMessage));
      }
  ...
  var handleFileChange = function handleFileChange(event) {
    ...
    if (!file.type.startsWith('image/')) {
      var errorMessage = 'Please select a valid image file';
      setError(errorMessage);
      if (onError) {
        onError(new Error(errorMessage));
      }
  ...
  var defaultInputStyle = _objectSpread2({
    display: 'none'
  }, inputStyle);
  var defaultButtonStyle = _objectSpread2({
  ...
  var defaultPreviewStyle = _objectSpread2({
    maxWidth: '300px',
    maxHeight: '300px',
    marginTop: '1rem',
    borderRadius: '8px',
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx("input", {
      ...
      style: _objectSpread2(_objectSpread2({}, defaultButtonStyle), {}, {
        backgroundColor: isProcessing ? '#6c757d' : defaultButtonStyle.backgroundColor,
        cursor: isProcessing ? 'not-allowed' : 'pointer'
      }),
      className: buttonClassName,
      children: isProcessing ? 'Processing...' : buttonText
    }), showPreview && preview && /*#__PURE__*/jsxRuntime.jsxs("div", {
      style: {
        marginTop: '1rem',
        textAlign: 'center'
      },
      ...
      }), /*#__PURE__*/jsxRuntime.jsx("br", {}), /*#__PURE__*/jsxRuntime.jsx("button", {
...
exports.QrCameraScanner = QrCameraScanner;
exports.QrImageUploader = QrImageUploader;
